...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Set callback if it fires in future
          ...
          <div className="mb-4 p-4 rounded-2xl bg-gradient-to-r from-gold/15 to-yellow-600/15 border border-gold/40 flex items-center justify-between shadow-lg shadow-gold/5 animate-fadeIn">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <span className="block text-[10px] text-neutral-400 font-semibold font-sans leading-tight">Get every FIFA World Cup 2026 fixture in IST, even offline.</span>
              </div>
            </div>
            <button
              onClick={handleInstallClick}
              className="cursor-pointer px-3.5 py-1.5 bg-gold hover:bg-yellow-450 text-black text-[10px] font-black uppercase rounded-lg tracking-wider shadow-lg transition-all shrink-0"
            >
              📲 Install World Cup Daily
            </button>
          </div>
        )}
